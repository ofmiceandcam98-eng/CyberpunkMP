...
For devs meanwhile: a PRE-RELEASE test build is up (v0.3.58-authority-test.1, invisible to player launchers) with the branch DLL, SHA256, connect instructions for the self-updating test server at 100.90.85.33:11778, and the PR 5 test script.
