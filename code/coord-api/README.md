...
| API for everyone else | `http://100.109.102.127:11780/v1/` — over Tailscale |
...
```bash
curl -X POST "http://100.109.102.127:11780/v1/updates" \
...
curl -H "Authorization: Bearer <key>" \
     "http://100.109.102.127:11780/v1/updates?limit=10"
```
...
```bash
curl -H "Authorization: Bearer <key>" \
     "http://100.109.102.127:11780/v1/updates?since=2026-08-14T05:00:00Z"
```
